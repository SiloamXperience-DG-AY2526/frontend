...
import ManagersDataTable from '@/app/(superAdmin)/super-admin/managers/_components/ManagersDataTable';
import SubAdminAddManagerDialog from './_components/SubAdminAddManagerDialog';
import SearchBar from '@/components/ui/SearchBar';
import Button from '@/components/ui/Button';

export default function SubAdminManagersPage() {
